    """
    Port Scanner Cli Qs7azm3k
    =========================
    Zero-dependency command-line tool designed to organise local resources efficiently.
    ...
    APP_NAME    = "Port Scanner Cli Qs7azm3k"
    APP_VERSION = "1.0.0"
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Zero-dependency command-line tool designed to organise local resources efficiently.")
